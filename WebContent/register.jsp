...
<body>
   ...
   <div class="col-md-8">
    <div class="marquee" style="border:2px black hidden; background-color:white">
        ...
        <div  class="marquee-content" style="align:center; padding-top:5px;min-height:750px;background-color:#26b0b0">
		...
		<tr>
			<td>
				...
				<br>
                    ...
                    <input type="submit" value="Register" name="user" style="background-color: #26b0b0; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer;">
