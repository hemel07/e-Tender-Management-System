...
<body>
	...
	<div class="clearfix hidden-sm hidden-xs" style="color:rgb(13, 0, 0);background-color: rgb(28, 195, 233); margin-top:-15px; margin-bottom: 12px"><marquee>Welcome to Tender Management Site</marquee>
