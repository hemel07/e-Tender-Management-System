...
<body>
	...
	<div class="clearfix hidden-sm hidden-xs" style="color:rgb(10, 0, 0);background-color: rgb(28, 195, 233); margin-top:-15px; margin-bottom: 12px"><marquee>Welcome to Tender Management Site</marquee>
   ...
   <div class="col-md-8">
    <div class="marquee" style="border:2px black hidden; background-color:white">
        ...
        <div class="marquee-content" style="text-align: center; padding-top: 200px; min-height: 750px; background-image: url('images/bidderB.png'); background-size: 100% 100%; background-repeat: no-repeat;">
